...
contract Strategy is BaseStrategy {
        ...
        )
    {
        ...
        uint256 assets = wantBalance.add(calcWantHeldInVesper());
    ...
    function morePrecisePricePerShare() public view returns (uint256) {
        ...
        return IVesperPool(vWBTC)
            .totalValue().mul(DENOMINATOR) // denominated 1e8
            .div(IVesperPool(vWBTC).totalSupply());
    }
}
